...
const AI_AGENT_PROMPT = `Read ${ICONS_DOC_URL} and follow the instructions to use @hanzoai/icons`;
const ICONS_INSTALL_COMMAND = 'npm i @hanzoai/icons';
...
const items: FeaturesProps['items'] = [
  ...
  {
    description:
      'Hanzo Icons boasts an active community of designers and developers. Engage with us on platforms like GitHub and Discord to contribute or get support.',
    icon: GitPullRequest,
    ...
    <Flexbox gap={64} paddingBlock={64}>
      <Hero
        ...
        actions={[
          {
            github: true,
            link: 'https://github.com/hanzoai/icons',
            openExternal: true,
            text: 'GitHub',
          },
          {
        ...
        <AgentGuideCard
          ...
          sections={{
            agent: {
              ...
              description: 'Send this prompt to your agent to use @hanzoai/icons',
            },
            human: {
              command: ICONS_INSTALL_COMMAND,
              commandLanguage: 'shell',
              description: 'Install @hanzoai/icons with npm and start using the icon set',
